...
from image_detection.layers.DetectionLayer import DetectionLayer
from image_detection.layers.DetectionTargetLayer import DetectionTargetLayer
from image_detection.layers.FPN import fpn_classifier_graph, build_fpn_mask_graph
...
from image_detection.loss import rpn_class_loss_graph, rpn_bbox_loss_graph, mrcnn_class_loss_graph, \
    mrcnn_bbox_loss_graph, mrcnn_mask_loss_graph
from image_detection.utils.anchors import generate_pyramid_anchors
from image_detection.utils.utils import log
from image_detection.utils.dataformat import parse_image_meta_graph, mold_image, compose_image_meta
...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        rpn_rois = ProposalLayer(proposal_count=proposal_count, nms_threshold=config.RPN_NMS_THRESHOLD, name="ROI",
                                 anchors=self.anchors, config=config)([rpn_class, rpn_bbox])
        if mode == "training":
