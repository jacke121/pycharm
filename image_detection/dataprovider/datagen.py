...
from image_detection.dataprovider import anchorgen
from image_detection.dataprovider import utils
...
def load_image_gt(dataset, config, image_id, augment=False,
    ...
    # Image meta data
    image_meta = dataformat.compose_image_meta(image_id, shape, window, active_class_ids)
