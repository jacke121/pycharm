...
DATA_DIR = '/home/andrew/PycharmProjects/algorithm-project/datasets/image/cifar-10-batches-py'
if len(DATA_DIR) == 0:
...
if not os.path.exists("cifar_output"):
    os.mkdir("cifar_output")

def generate_image(frame, true_dist):
    samples = session.run(fixed_noise_samples_128)
    samples = ((samples + 1.) * (255. / 2)).astype('int32')
    lib.save_images.save_images(samples.reshape((128, 3, 32, 32)), 'cifar_output/samples_{}.jpg'.format(frame))
