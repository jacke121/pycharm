...
image_dir = "maps"
dataset_dir = "/home/andrew/PycharmProjects/algorithm-project/datasets/unpair_image/"+image_dir
assert len(glob('{}/*.*'.format(dataset_dir + '/trainA'))) > 0

parser = argparse.ArgumentParser(description='')
parser.add_argument('--dataset_dir', dest='dataset_dir', default=dataset_dir, help='path of the dataset')
