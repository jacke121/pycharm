...
type_img = "voc_pair2012"
# mode = "train"
# checkpoint = None
mode = "test"
checkpoint = type_img+"_train"

suffix = "train" if mode == "train" else "val"
parser = argparse.ArgumentParser()
parser.add_argument("--input_dir", default="/home/andrew/PycharmProjects/algorithm-project/datasets/image/" +
                                           type_img + "/" + suffix,
                    help="path to folder containing images")
parser.add_argument("--mode", default=mode, choices=["train", "test", "export"])
parser.add_argument("--output_dir", default=type_img + "_train", help="where to put output files")
...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    for decoder_layer, (out_channels, dropout) in enumerate(layer_specs):
        ...
        with tf.variable_scope("decoder_%d" % (skip_layer + 1)):
            ...
            if dropout > 0.0 and a.mode == "train":
